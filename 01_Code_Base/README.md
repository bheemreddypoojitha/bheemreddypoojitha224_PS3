To make your `README.md` look professional on GitHub, you need to use **Markdown syntax** (headers, code blocks, bold text, and lists).

Here is your content formatted specifically for a **GitHub repository**. Copy the code block below and replace your current `README.md` content with it.
